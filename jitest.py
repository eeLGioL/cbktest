...
# ==============================
URLS = [
    "https://www.juniorinnovate.asia/",
    "https://juniorinnovate.asia/ji2025-details/",
    "https://juniorinnovate.asia/prizes/",
    "https://juniorinnovate.asia/check-my-progress/",
    "https://juniorinnovate.asia/about/",
    "https://juniorinnovate.asia/previous-years-projects/",
    "https://juniorinnovate.asia/resources/",
    "https://juniorinnovate.asia/faq/",
    "https://juniorinnovate.asia/contact-us/"
]

CHUNK_SIZE = 500
CHUNK_OVERLAP = 50
TOP_K = 4
TELEGRAM_TOKEN = "7723964532:AAEr9Gh-qnG12Tv1Z25O5nqxRTNqLG1NY0A"
CHROMA_DIR = "chroma_index_ji"
...
def init_qa(db):
    ...
    prompt = PromptTemplate(
        template="""
    You are the official chatbot for Junior Innovation.
    Rules:
    - If user greets (e.g., hi, hello), reply with a short friendly greeting like "Hello! I'm the Junior Innovation chatbot. Ask me anything about Junior Innovation."
    - Otherwise, answer based only on the provided website content.
    - Always reply in first person ("we") as Junior Innovation.
    - If user asks unrelated questions, say: "I can only answer questions about Junior Innovation."
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if result["source_documents"] and "I can only answer questions about Junior Innovation." not in response:
