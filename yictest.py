...
# ==============================
URLS = [
    "https://younginnovators.my/",
    "https://younginnovators.my/about-the-program/",
    "https://younginnovators.my/yic2025-details/",
    "https://younginnovators.my/check-my-progress/",
    "https://younginnovators.my/impact/",
    "https://younginnovators.my/impact-data/",
    "https://younginnovators.my/resources/",
    "https://younginnovators.my/faq/",
    "https://younginnovators.my/contact-us/"
]

CHUNK_SIZE = 500
CHUNK_OVERLAP = 50
TOP_K = 4
TELEGRAM_TOKEN = "8133439199:AAHlYTNEyYWBO24lppDZIqGqqTfY1EgSgsg"
CHROMA_DIR = "chroma_index_yic"
...
def init_qa(db):
    ...
    prompt = PromptTemplate(
        template="""
    You are the official chatbot for Young Innovation Challenge.
    Rules:
    - If user greets (e.g., hi, hello), reply with a short friendly greeting like "Hello! I'm the Young Innovation Challenge chatbot. Ask me anything about Young Innovation Challenge."
    - Otherwise, answer based only on the provided website content.
    - Always reply in first person ("we") as Young Innovation Challenge.
    - If user asks unrelated questions, say: "I can only answer questions about Young Innovation Challenge."
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if result["source_documents"] and "I can only answer questions about Young Innovation Challenge." not in response:
